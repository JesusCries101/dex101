...
var Client = /** @class */ (function () {
    ...
    Client.prototype.start = function () {
        ...
        return new Promise(function (resolve, reject) { return (core_1.toolbelt.Promise.resolve({
            ...
            p._.ws
                ...
                .then(function () { return p._.config.dataToResAction(data.toString()); })
    ...
    Client.prototype.dispatch = function (action) {
        ...
        return p._.queuefy(function () { return new Promise(function (resolve, reject) { return (core_1.toolbelt.Promise.resolve()
            ...
            core_1.toolbelt.Promise.reject(new Error('websocket not ready')) : (core_1.toolbelt.Promise.resolve()
            .then(function () { return p._.config.reqActionToData(action); })
            .then(function (data) { return p._.ws.send(data); })))); })
